...
function missionToForm(mission) {
  ...
  return {
    ...
    ageMin:
      (_d =
        (_c = mission.age_min) === null || _c === void 0
          ? void 0
    ...
    ageMax:
      (_f =
        (_e = mission.age_max) === null || _e === void 0
          ? void 0
    ...
    sortOrder: String(
      (_j = mission.sort_order) !== null && _j !== void 0 ? _j : 0,
    ),
    selectionTags: ((_k = mission.selection_tags) !== null && _k !== void 0
      ? _k
      : []
    ).join(", "),
    targetWords: ((_l = mission.target_words) !== null && _l !== void 0
      ? _l
      : []
    ).join("\n"),
    conversationPrompts: ((_m = mission.conversation_prompts) !== null &&
    _m !== void 0
      ? _m
      : []
    ).join("\n"),
...
function getStatusLabel(status) {
  var _a, _b;
  return (_b =
    (_a = STATUS_OPTIONS.find(function (option) {
...
function getSurfaceLabel(surface) {
  var _a, _b;
  return (_b =
    (_a = SURFACE_OPTIONS.find(function (option) {
      return option.value === surface;
    })) === null || _a === void 0
      ? void 0
      : _a.label) !== null && _b !== void 0
    ? _b
...
function AdminPage() {
  var _a = (0, auth_context_1.useAuth)(),
    user = _a.user,
    authLoading = _a.loading;
  var toast = (0, use_toast_1.useToast)().toast;
  var _b = (0, react_1.useState)([]),
    missions = _b[0],
    setMissions = _b[1];
  var _c = (0, react_1.useState)(null),
    selectedMissionId = _c[0],
    setSelectedMissionId = _c[1];
  var _d = (0, react_1.useState)(createEmptyMissionForm()),
    form = _d[0],
    setForm = _d[1];
        ...
        switch (_d.label) {
          ...
          case 2:
            ...
            targetMissionId_1 =
              (_c =
                (_a =
                  nextSelectedMissionId !== null &&
                  nextSelectedMissionId !== void 0
                    ? nextSelectedMissionId
                    : selectedMissionId) !== null && _a !== void 0
                  ? _a
                  : (_b = catalog[0]) === null || _b === void 0
                    ? void 0
                    : _b.id) !== null && _c !== void 0
                ? _c
                : null;
            setSelectedMissionId(targetMissionId_1);
            selectedMission = catalog.find(function (mission) {
              return mission.id === targetMissionId_1;
            });
            setForm(
              selectedMission
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (0, missions_1.updateAdminMission)(selectedMissionId, payload),
            ];
          case 2:
            savedMission = _a.sent();
            return [3 /*break*/, 5];
          case 3:
            return [4 /*yield*/, (0, missions_1.createAdminMission)(payload)];
          case 4:
            savedMission = _a.sent();
            _a.label = 5;
          case 5:
            return [4 /*yield*/, loadMissions(savedMission.id)];
          case 6:
            _a.sent();
            toast({
          ...
          case 7:
            ...
            description =
              saveError_1 instanceof Error && saveError_1.message
                ? saveError_1.message
                : "請檢查欄位內容後再試。";
            toast({
              title: "儲存失敗",
  ...
  var draftCount = missions.filter(function (mission) {
    return mission.status === "draft";
  }).length;
  var publishedCount = missions.filter(function (mission) {
    return mission.status === "published";
  }).length;
  var archivedCount = missions.filter(function (mission) {
    return mission.status === "archived";
  }).length;
  if (authLoading) {
    return (
      <CozyPageWrapper_1.default type="dashboard" hideThemeToggle>
  ...
  return (
    <CozyPageWrapper_1.default type="dashboard" hideThemeToggle>
      <div className="container mx-auto max-w-7xl px-4 py-8 pb-24">
        ...
        {error && (
          <alert_1.Alert className="mb-6 rounded-3xl border-amber-200 bg-amber-50 text-amber-800">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.15fr,0.85fr]">
                      ...
                      {filteredMissions.map(function (mission) {
                        ...
                        return (
                          <table_1.TableRow
                            key={mission.id}
                            onClick={function () {
                              return handleSelectMission(mission);
                            }}
          ...
          <card_1.Card className="rounded-4xl border-none bg-white/85 shadow-sm backdrop-blur-md">
            ...
            <card_1.CardContent className="space-y-5 pt-5">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <input_1.Input
                    ...
                    value={form.title}
                    onChange={function (event) {
                      return updateForm("title", event.target.value);
                    }}
                ...
                <div className="space-y-2">
                  ...
                  <input_1.Input
                    ...
                    value={form.slug}
                    onChange={function (event) {
                      return updateForm("slug", event.target.value);
                    }}
              ...
              <div className="space-y-2">
                <label_1.Label htmlFor="mission-description">
                  描述
                </label_1.Label>
                <textarea_1.Textarea
                  ...
                  onChange={function (event) {
                    return updateForm("description", event.target.value);
                  }}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <select_1.Select
                    value={form.context}
                    onValueChange={function (value) {
                      return updateForm("context", value);
                    }}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <select_1.Select
                    value={form.status}
                    onValueChange={function (value) {
                      return updateForm("status", value);
                    }}
                  >
                    <select_1.SelectTrigger className="h-11 w-full rounded-2xl border-slate-200">
                      <select_1.SelectValue />
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <select_1.Select
                    value={form.surface}
                    onValueChange={function (value) {
                      return updateForm("surface", value);
                    }}
                  >
                    <select_1.SelectTrigger className="h-11 w-full rounded-2xl border-slate-200">
                      <select_1.SelectValue />
                    ...
                    <select_1.SelectContent>
                      {SURFACE_OPTIONS.map(function (option) {
                        return (
                          <select_1.SelectItem
                            key={option.value}
                            value={option.value}
                ...
                <div className="space-y-2">
                  ...
                  <input_1.Input
                    ...
                    value={form.locale}
                    onChange={function (event) {
                      return updateForm("locale", event.target.value);
                    }}
                    className="h-11 rounded-2xl border-slate-200"
                  />
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <input_1.Input
                    ...
                    value={form.ageMin}
                    onChange={function (event) {
                      return updateForm("ageMin", event.target.value);
                    }}
                    className="h-11 rounded-2xl border-slate-200"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input_1.Input
                    ...
                    value={form.ageMax}
                    onChange={function (event) {
                      return updateForm("ageMax", event.target.value);
                    }}
                    className="h-11 rounded-2xl border-slate-200"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input_1.Input
                    ...
                    onChange={function (event) {
                      return updateForm("sortOrder", event.target.value);
                    }}
                    className="h-11 rounded-2xl border-slate-200"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <input_1.Input
                  ...
                  onChange={function (event) {
                    return updateForm("difficulty", event.target.value);
                  }}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <textarea_1.Textarea
                    ...
                    onChange={function (event) {
                      return updateForm("targetWords", event.target.value);
                    }}
                ...
                <div className="space-y-2">
                  <label_1.Label htmlFor="conversation-prompts">
                    對話提示
                  </label_1.Label>
                  <textarea_1.Textarea
              ...
              <div className="space-y-2">
                ...
                <input_1.Input
                  ...
                  onChange={function (event) {
                    return updateForm("selectionTags", event.target.value);
                  }}
              ...
              <div className="space-y-2">
                <label_1.Label htmlFor="catalog-metadata">
                  Catalog Metadata JSON
                </label_1.Label>
                <textarea_1.Textarea
                  id="catalog-metadata"
                  value={form.catalogMetadata}
                  onChange={function (event) {
                    return updateForm("catalogMetadata", event.target.value);
                  }}
                  placeholder='{"theme": "family", "estimated_minutes": 5}'
                  className="min-h-28 rounded-2xl border-slate-200 font-mono text-sm"
                />
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="flex items-center justify-between rounded-3xl border border-slate-200 bg-slate-50 px-4 py-3">
                  ...
                  <switch_1.Switch
                    ...
                    onCheckedChange={function (checked) {
                      return updateForm("isOffline", checked);
                    }}
                  />
                </div>
                ...
                <div className="flex items-center justify-between rounded-3xl border border-slate-200 bg-slate-50 px-4 py-3">
                  ...
                  <switch_1.Switch
                    ...
                    onCheckedChange={function (checked) {
                      return updateForm("isActive", checked);
                    }}
                  />
                </div>
              </div>
