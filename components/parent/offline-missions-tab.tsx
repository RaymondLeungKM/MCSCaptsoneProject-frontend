...
// We import the data which is now in Chinese from your mock-data file
...
export function OfflineMissionsTab() {
  ...
  const getContextIcon = (context: OfflineMission["context"]) => {
    switch (context) {
      case "mealtime": return <Utensils className="w-5 h-5" />;
      case "bedtime": return <Moon className="w-5 h-5" />;
      case "playtime": return <Gamepad2 className="w-5 h-5" />;
  ...
  const getContextLabel = (context: OfflineMission["context"]) => {
    switch (context) {
      case "mealtime": return "用餐時間";
      case "bedtime": return "睡前時光";
      case "playtime": return "遊戲時間";
      case "outdoor": return "戶外活動";
      case "shopping": return "購物時間";
      default: return "日常對話";
    }
  };
  ...
  const getContextColorClasses = (context: OfflineMission["context"]) => {
    switch (context) {
      case "mealtime": return "bg-orange-100 text-orange-600 border-orange-200";
      case "bedtime": return "bg-indigo-100 text-indigo-600 border-indigo-200";
      case "playtime": return "bg-pink-100 text-pink-600 border-pink-200";
      case "outdoor": return "bg-green-100 text-green-600 border-green-200";
      case "shopping": return "bg-blue-100 text-blue-600 border-blue-200";
              ...
              >
                ...
                >
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            {/* Translated Label */}
                            <span className={cn("text-xs font-bold tracking-wider px-2 py-0.5 rounded-full border", contextColors)}>
                          ...
                          <h3 className={cn("text-lg font-bold text-slate-800 truncate pr-4", mission.completed && "line-through opacity-60")}>
                            {mission.title}
                          </h3>
                        </div>
                        ...
                        <button
                          ...
                          title={mission.completed ? "標記為未完成" : "標記為完成"}
                        >
                  ...
                  <div className="flex justify-center mt-2 -mb-2">
                     {isSelected ? <ChevronUp className="w-4 h-4 text-slate-300" /> : <ChevronDown className="w-4 h-4 text-slate-300 group-hover:text-blue-400 transition-colors" />}
                  </div>
                </div>
                    ...
                    <div className="overflow-hidden">
                        <div className="p-5 space-y-4">
                            ...
                            <div className="flex items-start gap-3 bg-yellow-50 text-yellow-800 p-4 rounded-xl border border-yellow-100">
                                <span className="text-xl"><Lightbulb className="w-5 h-5 text-yellow-600" /></span>
                                <div className="text-sm">
                                    <strong className="block mb-1 font-bold">家長小貼士</strong>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="flex gap-3">
                ...
                <div>
                    ...
                    <span className="text-indigo-700/80">小朋友可能要聽 6-12 次才會記得一個新詞彙。</span>
                </div>
            </div>
            <div className="flex gap-3">
                ...
                <div>
                    ...
                    <span className="text-indigo-700/80">用有趣的聲線、誇張的動作，令學習變成遊戲。</span>
                </div>
            </div>
            <div className="flex gap-3">
                ...
                <div>
                    ...
                    <span className="text-indigo-700/80">談論他們正在注視或感興趣的事物。</span>
                </div>
            </div>
             <div className="flex gap-3">
                ...
                <div>
                    ...
                    <span className="text-indigo-700/80">讚賞他們的每一次嘗試，即使發音未完全準確。</span>
                </div>
            </div>
        </div>
      </div>
