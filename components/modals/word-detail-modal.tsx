...
export function WordDetailModal({
  ...
  const recordExposure = async (
    ...
    try {
      ...
      const didIncreaseExposure = progress.exposure_count > exposureCount;
          ...
          >
            ...
            <div className="mt-4 flex flex-col gap-2">
              ...
              >
                ...
                />
                {isLoading ? "準備中..." : isPlaying ? "播放中..." : "聆聽發音"}
              </button>
            ...
            {footerAction && (
              <div className="mt-3 flex justify-center">{footerAction}</div>
            )}
          </div>
