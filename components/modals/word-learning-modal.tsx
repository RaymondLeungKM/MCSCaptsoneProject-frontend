        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8">
          ...
          {currentStep === "example" && (
            <div className="flex flex-col items-center justify-center text-center animate-in fade-in slide-in-from-right-8">
              ...
              <div className="bg-linear-to-br from-yellow-50 to-orange-50 rounded-4xl p-6 w-full border border-yellow-100 shadow-sm mb-6 relative overflow-hidden">
              ...
              >
                ...
                {isLoading ? "準備中..." : isPlaying ? "播放中..." : "播放例句"}
              </button>
            </div>
          )}
          ...
          {currentStep === "ai-sentences" && (
            <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-8">
              ...
              <div className="flex-1 bg-slate-50 rounded-3xl p-2 border border-slate-100">
                <AISentences
                  wordId={word.id}
                  languagePreference={languagePreference}
                />
